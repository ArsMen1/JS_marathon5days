...
// выбор времени для кнопок на втором экране
...
// счетчик нажатий на фигуру + перенос фигуры
...
function createRandomCircle() {
  ...
  youFigure = figure[getRandomNumber(0, figure.length - 1)];
...
function winTheGame() {
  function kill() {
    const circle = document.querySelector(".board>div");
    if (circle) {
      circle.click();
    }
  }
